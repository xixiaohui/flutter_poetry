...
abstract class $PaginatedResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<T> data, int total, int page, int pageSize, bool hasMore});
}
...
class _$PaginatedResponseImpl<T> implements _PaginatedResponse<T> {
  ...
  @override
  String toString() {
    return 'PaginatedResponse<$T>(data: $data, total: $total, page: $page, pageSize: $pageSize, hasMore: $hasMore)';
  }
